...
namespace MonoGame.Extended
{
        ...
        IEquatableByRef<BoundingRectangle>
    {
        ...
        {
            PrimitivesHelper.CreateRectangleFromPoints(points, out Vector2 minimum, out Vector2 maximum);
        ...
        public static void Union(ref BoundingRectangle first, ref BoundingRectangle second, out BoundingRectangle result)
        {
            ...
            var minimum = Vector2Extensions.Minimum(firstMinimum, secondMinimum);
            var maximum = Vector2Extensions.Maximum(firstMaximum, secondMaximum);
            ...
            ref BoundingRectangle second, out BoundingRectangle result)
        {
            ...
            var minimum = Vector2Extensions.Maximum(firstMinimum, secondMinimum);
            var maximum = Vector2Extensions.Minimum(firstMaximum, secondMaximum);
        ...
        public Vector2 ClosestPointTo(Vector2 point)
        {
            ...
            PrimitivesHelper.ClosestPointToPointFromRectangle(Center - HalfExtents, Center + HalfExtents, point, out Vector2 result);
            return result;
        }
        ...
        {
            if (obj is BoundingRectangle rectangle)
